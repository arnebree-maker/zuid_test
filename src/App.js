...
import { ChevronRight, ChevronDown, Link as LinkIcon, HelpCircle, Home, Lightbulb, BookOpen, X, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6">
              ...
              <div className="p-6 sm:p-7 bg-gradient-to-br from-slate-50 to-blue-50">
                ...
                <div className="mt-5 space-y-3">
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    <div className="bg-gradient-to-br from-orange-400 to-amber-500 rounded-2xl p-5 shadow-lg transform hover:scale-105 transition-transform">
                      <p className="text-xs font-bold mb-2 tracking-wide text-white">COLLECTIEVE INSPIRATIE!</p>
                      <p className="text-sm mb-4 text-white">Bekijk wat je collega's hebben gemaakt en voeg jouw beste ideeën toe!</p>
                      <a href="https://drive.google.com/drive/folders/12hkdkdgrNgK8W3b5qXjJvcPaKsinLEuj?usp=drive_link" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 w-full bg-white text-orange-700 font-semibold hover:bg-orange-50 rounded-xl px-5 py-3 shadow-md transition-all duration-200 hover:scale-105">
                        <LinkIcon className="h-4 w-4" /> Drop je eigen ideeën hier
                      </a>
                    </div>
                  </div>
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl p-4 mt-4">
                    <div className="flex items-center gap-2 text-purple-700">
                      <Sparkles className="h-5 w-5" />
                      <p className="text-sm font-bold">Deze website is gemaakt met AI</p>
                    </div>
                    <p className="text-xs text-purple-600 mt-1">Gebouwd met Lovable.dev - een voorbeeld van AI in de praktijk!</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="p-0 overflow-hidden group mt-6">
          <button 
            onClick={() => setShowWhyAI(!showWhyAI)}
            className="w-full p-6 sm:p-7 flex items-center justify-between gap-3 bg-gradient-to-br from-emerald-500 via-teal-600 to-cyan-600 hover:from-emerald-600 hover:via-teal-700 hover:to-cyan-700 transition-all duration-200 cursor-pointer"
          >
            ...
            <ChevronDown className={`h-6 w-6 text-white transition-transform duration-300 ${showWhyAI ? 'rotate-180' : ''}`} />
          </button>

          {showWhyAI && (
            <div className="divide-y divide-gray-200/50 animate-in fade-in duration-200">
